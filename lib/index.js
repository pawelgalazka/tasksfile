...
function call(obj, args) {
    ...
    Object.keys(obj).forEach(function (t) {
        ...
        obj[t] = function () {
            var time = Date.now();
            console.log(_chalk2['default'].blue('Running "' + t + '"...'));
            task.apply(null, arguments);
            time = ((Date.now() - time) / 1000).toFixed(2);
            console.log(_chalk2['default'].blue('Finished "' + t + '" in', time, 'sec'));
        };
    });
    ...
    if (task) {
        ...
        console.log(_chalk2['default'].red("Task " + taskName + " not found"));
    }
}
